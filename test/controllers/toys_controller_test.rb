...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { availability: @toy.availability, category: @toy.category, condition: @toy.condition, description: @toy.description, name: @toy.name, price: @toy.price } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { availability: @toy.availability, category: @toy.category, condition: @toy.condition, description: @toy.description, name: @toy.name, price: @toy.price } }
